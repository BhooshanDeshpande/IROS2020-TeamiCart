...
car_width = 0.5 # Car width = half of the car plus tolerance
width_tolerance = 2.0
...
turn_clearance = 0.25
max_turn_angle = 24.0
min_speed = 0.0  # Last tunable param
max_speed = 0.0  # Max Val : 20
min_distance = 0.6
max_distance = 5.0  # Tune this param
right_extreme = 180
left_extreme = 900
...
def lidar_callback(data):
    ...
    gaussian_weights = gaussian(gauss_range,540,100) 
    ...
    scan.header.frame_id = 'opp_racecar/laser'
    scan.angle_min = -1.57
    scan.angle_max = 1.57
    ...
    # Publish marker
    markermsg = Marker()
    markermsg.header.frame_id = "opp_racecar/laser"
...
if __name__ == '__main__':
    ...
    pub_drive_param = rospy.Publisher('/opp_id/drive', AckermannDriveStamped, queue_size=5)
    rospy.Subscriber('/opp_id/scan', LaserScan, lidar_callback)
    scan_pub = rospy.Publisher('/opp_id/modified_scan',LaserScan, queue_size=100)
